...
const ExploreCard: React.FC<ExploreCardProps> = ({
  ...
  return (
    ...
    >
      <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4 bg-gradient-to-r from-white to-white/10">
      ...
      <a 
        href={link || "#"} 
        className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-2 text-sm bg-gradient-to-r from-white to-white/10 text-[var(--white)] hover:from-[#cccccc] hover:to-white transition-colors"
      >
        Explore Platform
