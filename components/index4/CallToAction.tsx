  ...
  return (
    <section className="max-w-4xl mx-auto mb-16">
      <motion.div
        ...
        className="backdrop-blur-xl bg-gradient-to-b from-neutral-900/40 to-neutral-900/80 border border-neutral-800/50 rounded-2xl p-10 text-center"
      >
        ...
        <Button 
          size="lg" 
          className="h-12 px-8 bg-[var(--white)] hover:bg-neutral-200 text-primary-foreground transition-colors duration-300"
        >
