      ...
      >
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="sm"
              className="bg-[var(--white)] text-primary-foreground hover:bg-transparent hover:text-[var(--white)] hover:border-[var(--white)] border border-transparent rounded-full transition-all duration-300"
            >
              Get Started
