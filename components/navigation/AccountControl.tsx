...
/**
 * AccountControl — the signed-in/out affordance for the HanzoHeader `account`
 * slot. This is the ONLY bespoke piece the unified shell needs from hanzo.ai:
 * the IAM session. Everything else (brand, nav, CTAs, Meet-Hanzo menu) comes
