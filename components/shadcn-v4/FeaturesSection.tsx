  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background/30">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">What's New in v4?</h2>
