  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 mb-16">
        ...
        >
          <Button size="lg" className="text-lg px-8 bg-primary hover:bg-[#cccccc] border-none">
            Get Started
          </Button>
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <a href="#platform" className="text-muted-foreground hover:text-[var(--white)] transition-colors flex items-center justify-center">
            Scroll to explore
