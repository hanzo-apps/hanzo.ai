        ...
        >
          <div className="text-center space-y-4">
            <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-foreground" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-[var(--white)]">Explore More</h3>
            <p className="text-foreground/80 text-sm">Discover our full range of cloud solutions and services</p>
            <Button 
              className="mt-2 bg-primary hover:bg-[#cccccc] text-[var(--white)] border-none"
              radius="full"
            >
              View All Services
            </Button>
