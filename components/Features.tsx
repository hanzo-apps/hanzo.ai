...
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious } from "@hanzo/ui";
      ...
      <section id="features" className="py-20 bg-[var(--black)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 border-t border-border">
          <motion.div initial={{
            ...
            <h2 className="font-display text-[var(--white)] bg-gradient-to-r from-white/20 via-white/15 to-white/10 bg-clip-text text-transparent text-4xl">
