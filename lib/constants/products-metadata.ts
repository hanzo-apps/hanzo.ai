...
export const productsMetadata: Record<string, ProductMetadata> = {
  ...
  analytics:    { slug: 'analytics',  tagline: 'Product analytics on your data', license: 'Apache-2.0', github_repo: `${G}/analytics` },
  ...
  auto:         { slug: 'auto',       tagline: 'Workflow automations', license: 'Apache-2.0', github_repo: G },
  ...
  dataroom:     { slug: 'dataroom',   tagline: 'Secure data room', license: 'Apache-2.0', github_repo: `${G}/dataroom` },
  ...
  gateway:      { slug: 'gateway',    tagline: 'API gateway', license: 'Apache-2.0', github_repo: `${G}/gateway` },
  ...
  operative:    { slug: 'operative',  tagline: 'Computer-use harness', license: 'Apache-2.0', github_repo: `${G}/operative` },
  ...
  platform:     { slug: 'platform',   tagline: 'PaaS — deploy from git', license: 'Apache-2.0', github_repo: `${G}/platform`, upstream_fork: 'Dokploy', upstream_license: 'MIT', upstream_url: 'https://dokploy.com' },
  ...
  search:       { slug: 'search',     tagline: 'AI-powered search', license: 'Apache-2.0', github_repo: `${G}/search` },
  ...
  sign:         { slug: 'sign',       tagline: 'E-signature', license: 'Apache-2.0', github_repo: `${G}/sign` },
  ...
  storage:      { slug: 'storage',    tagline: 'S3-compatible object storage', license: 'AGPL-3.0', github_repo: `${G}/storage`, upstream_fork: 'MinIO', upstream_license: 'AGPL-3.0', upstream_url: 'https://min.io' },
  stream:       { slug: 'stream',     tagline: 'Event stream', license: 'Apache-2.0', github_repo: `${G}/stream` },
  studio:       { slug: 'studio',     tagline: 'Visual builder studio', license: 'Apache-2.0', github_repo: `${G}/studio` },
  ...
  vector:       { slug: 'vector',     tagline: 'Vector database', license: 'Apache-2.0', github_repo: `${G}/vector` },
  ...
  s3:           { slug: 's3',         tagline: 'S3-compatible object storage', license: 'AGPL-3.0', github_repo: `${G}/storage`, upstream_fork: 'MinIO', upstream_license: 'AGPL-3.0', upstream_url: 'https://min.io', docs_slug: 'storage' },
};
