...
const COMMERCE_API_URL = process.env.NEXT_PUBLIC_HANZO_API_URL || 'https://api.hanzo.ai';
...
export async function addPaymentMethod(
  ...
  const accessToken = typeof window !== 'undefined' ? localStorage.getItem('hanzo_access_token') : null;
...
export function getCryptoDepositAddress(
  ...
  return (
    process.env.NEXT_PUBLIC_CRYPTO_DEPOSIT_ADDRESS ||
