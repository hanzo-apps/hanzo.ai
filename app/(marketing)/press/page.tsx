...
const pressReleases = [
  { date: "February 27, 2026", title: "Hanzo Launches Unified AI Gateway — 100+ Models, Zero Markup", description: "Hanzo AI Gateway provides access to over 100 models from every major provider through a single API key with zero markup on third-party pricing.", link: "/blog" },
  ...
  { date: "February 27, 2026", title: "Zen4 Coder 480B: The Largest Open-Source Code Model", description: "Zen4 Coder 480B MoE delivers frontier-class code generation with only 22B active parameters, available through the Hanzo AI Gateway.", link: "/blog" },
