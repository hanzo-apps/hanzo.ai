        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          ...
          >
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">709</div>
              <div className="text-sm text-neutral-400">Tests Passing</div>
            </div>
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">50+</div>
              <div className="text-sm text-neutral-400">Contracts</div>
            </div>
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">PQ</div>
              <div className="text-sm text-neutral-400">Quantum-Safe</div>
            </div>
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-4">
              <div className="text-2xl font-bold text-[#fd4444]">BSD-3</div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 rounded-lg bg-green-500/10 flex items-center justify-center">
                        <Icon className="w-4 h-4 text-[#fd4444]" />
                      </div>
